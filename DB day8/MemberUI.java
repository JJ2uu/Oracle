	...
	public MemberUI() {
		...
		search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				bag = dao.one(id);
				if (bag != null) {
					idField.setText(bag.getId());
					pwField.setText(bag.getPw());
					nameField.setText(bag.getName());
					telField.setText(bag.getTel());
				} else {
					JOptionPane.showMessageDialog(title, "존재하지 않는 계정입니다.");
				}
			} // action
		}); // search button
